...
(function($,$$){
    ...
    Route.prototype.parseXmlToObj = function (result, style) {
        ...
        var strguide, signage = "", streetName = "", nextStreetName = "", turnlatlon = "";
        var routesArr = [];
        ...
        var sim_strguide, streetNames = "", lastStreetName = "", linkStreetName = "", sim_turnlatlon = "", streetLatLon = "", streetDistance = "", segmentNumber = "";
        var simpleArr = [];
    ...
    Route.prototype.createFeature = function (lonlat, type) {
        ...
        if (type == "start") {
            ...
            iconUrl = "http://www.tianditu.com/images/route/routeDest.png";
        }
